...
?>
    ...
    <!-- ================= OUR TEAM AREA ============== -->
    <?php if($team_image) : ?>
        <section class="our_team_area_main" style="background-image: url(<?php echo $team_image['url']; ?>);">
            <div class="container">
                <div class="small_container">
    ...
    <?php endif; ?>
    <!-- ================= COMPANY TEAM SHOWCASE AREA ============== -->
    <?php if($do_want_to_show_you_team_members) : ?>
        <section class="company_members_area_main">
            <div class="container">
                <div class="small_container">
                    <div class="company_members_area">
                        <ul class="company_member_showcase_area">
                            <?php
                                foreach($team_members_area as $each_member) :
                                    $team_member_profile_picture = $each_member['team_member_profile_picture'];
                                    $team_member_name = $each_member['team_member_name'];
                                    $team_member_designation = $each_member['team_member_designation'];
                            ?>
                                            <li class="company_member_showcase wow fadeInDown" data-wow-offset="100" data-wow-duration="1.2s">
                                                <a href="#" class="team_member">
                                                    <img src="<?php echo $team_member_profile_picture['url']; ?>" alt="img" class="team_member_photo">
                                                    <div class="common_heading_small">
    ...
    <?php endif; ?>
    <!-- ================= FREE CONSULT AREA ============== -->
    <!-- <?php if($schedule_section_heading) : ?>
        <section class="free_consult_area_main">
            <div class="container">
                <div class="free_consult_area">
                    <div class="free_consult_heading wow slideInRight" data-wow-offset="100" data-wow-duration="1.2s">
                        <h3><?php echo $schedule_section_heading; ?></h3>
                    </div>
                    <a href="<?php echo $schedule_section_button['url']; ?>" class="common_btn wow slideInLeft" data-wow-offset="100" data-wow-duration="1.2s"><?php echo $schedule_section_button['title']; ?></a>
                </div>
            </div>
        </section>
    <?php endif; ?> -->

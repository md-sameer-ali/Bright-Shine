...
?>
                ...
                <div class="small_container">
                    <div class="posts_card_area">
                        <div class="row row_gap_class">
                            <div class="col-lg-6">
                                <a href="<?php echo get_the_permalink($all_blogs[0]->ID); ?>" class="big_card_area wow slideInLeft" data-wow-offset="100" data-wow-duration="1.5s">
                                    <div class="card_image_area">
                                        <?php echo get_the_post_thumbnail($all_blogs[0]->ID); ?>
                                    </div>
                                    <span class="date_main"><?php echo date('j.n.Y', strtotime($all_blogs[0]->post_modified)); ?></span>
                            ...
                            <div class="col-lg-6">
                                <div class="small_card_area_main wow slideInRight" data-wow-offset="100" data-wow-duration="1.5s">
                                    <?php 
    ...
    <?php 
        ...
        if($all_blogs_main) :
    ?>
    <section class="latest_blog_article_area_main">
        <div class="container">
            <div class="small_container">
                    ...
                    <div class="article_area_main">
                        ...
                        ?>
                                    <div class="article_box wow fadeInDown" data-wow-offset="100" data-wow-duration="1.5s">
                                        ...
                                        <span class="date_main"><?php echo date('j.n.Y', strtotime($each_blogs->post_modified)); ?></span>
